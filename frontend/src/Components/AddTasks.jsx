    ...
    return (
        <div  className='mt-5'>
            <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center gap-3'>
                ...
                <input type="text" name='description' required value={formData?.description} onChange={handleChange} placeholder='Write your task here' className="input input-bordered w-[80%] md:w-[50%]" />
